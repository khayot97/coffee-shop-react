...
const productsRetriver = createSelector(retrieveProduct, (products) => ({
    products,
}));
                    ...
                    <Stack flexDirection={"column"} alignItems={"center"}>
                        ...
                        <Stack className={"top-text"}>
                            ...
                            <input
                                ...
                                onKeyDown={(e) => {
                                    if (e.key === "Enter") searchPrdoductHandler();
                                }}
                            />
                            <Button
